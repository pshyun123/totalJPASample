...
@SpringBootTest
@TestPropertySource(locations = "classpath:application-test.properties") // 경로 설정
class ItemRepositoryTest {
        ...
        public void findByItemNameTest(){
            this.createItemList();
            List<Item> itemList = itemRepository.findByItemName("테스트 아이템5");
        ...
        @Test
        @DisplayName("상품명 or 상품 상세설명")
        public void findByItemNameOrItemDetailTest(){
            this.createItemList();
            List<Item> itemList = itemRepository
                    .findByItemNameOrItemDetail("test item1",
                    "테스트상품에 대한 상세설명 5");
            for(Item item : itemList) {
                System.out.println(item);
            }
        ...
        @Test
        @DisplayName("주어진 가격보다 저렴한 제품 조회")
